...
function handleFileUpload() {
    ...
    uploadBtn.addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, fetch("/dashboard/upload", {
                            method: "POST",
                            body: formData,
                        })];
                case 2:
                ...
                case 3:
                    error_1 = _b.sent();
                    console.error("Erro ao realizar o upload:", error_1);
                    return [3 /*break*/, 4];
